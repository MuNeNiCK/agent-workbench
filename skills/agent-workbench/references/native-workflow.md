...
5. Request a fresh review of the exact proposed design meaning.
...
10. Request bounded implementation review; record observations; let the caller accept, reject,
...
rather than silently retargeting work.
