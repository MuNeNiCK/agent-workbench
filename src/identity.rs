...
typed_handle!(DecisionContinuationHandle, "continuation_");
typed_handle!(ReviewerMigrationBindingHandle, "reviewer_binding_");
typed_handle!(BackupHandle, "backup_");
typed_handle!(AuditHandle, "audit_");
typed_handle!(ReviewProvenanceHandle, "review_provenance_");
typed_handle!(InvocationHandle, "review_invocation_");
