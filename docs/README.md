...
This directory contains the human-facing documentation for Agent Workbench.

Use these pages when you want to understand what the project is, decide whether
it fits your repository, install the Agent Skill, or review how agent work is
recorded.
...
- [Agent Skills](content/agent-skills.md) - What the skill provides and how to install it with `gh skill`.
- [Reference](content/reference.md) - Paths, command groups, environment variables, and gate names.
